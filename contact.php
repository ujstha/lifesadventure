    ...
    <div class="container h-100">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-12 text-center breadcrumb-fade">
                <p class="breadcrumbs wow fadeInUpBig" data-wow-delay="0.08s"><span class="mr-2"><a href="index.php">Home</a></span> <span>Contact</span></p>
                <h1 class="mb-3 bread text-light wow fadeInUpBig" data-wow-delay="0.2s">Contact Us</h1>
            </div>
        </div>
    </div>
</section>
